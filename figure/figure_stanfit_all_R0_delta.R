...
pred <- stanfit_all_R0_delta$par[grepl("C\\[", names(stanfit_all_R0_delta$par))]
...
quantile(data_Rsquared$Rsquared, c(0.025, 0.5, 0.975), na.rm=TRUE)
...
ggsave("figure_stanfit_all_R0_delta.pdf", gcomb, width=10, height=5)

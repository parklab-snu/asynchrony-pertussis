...
\begin{flushleft}{
	\Large
	\textbf\newline{
	  Delayed introduction, susceptible dynamics, and contact variation explain spatial asynchrony during the large pertussis outbreak in Korea
	}
}
\newline
\\
...
Integrating high-resolution surveillance data from 252 municipalities and a simple transmission model, I show that heterogeneity in introduction timing and local contact variation can drive such fine-scale asynchrony even when transmission is spatially homogeneous.

...
\begin{flushleft}{
	\Large
	\textbf\newline{
	  Delayed introduction and susceptible variation explain spatial asynchrony during the large pertussis outbreak in Korea
	}
}
\newline
\\
...
Using high-resolution surveillance data from 252 municipalities and a simple transmission model, I show that heterogeneity in introduction timing and local susceptibility can drive such fine-scale asynchrony even when transmission is spatially homogeneous.
...
In other words, the estimated susceptible fraction should be interpreted as the effective susceptibility that also captures behavioral and sociological factors, beyond immunological differences.
...
I assessed the relationshiip between estimated initial susceptible and vaccine coverage using linear regression.
